...
describe('Coin Functions', () => {
    ...
    describe('listCoins', () => {
        it('should list coins successfully', async () => {
            ...
            expect(console.log).toHaveBeenCalledWith(expect.stringContaining('Fetching available coins...'));
        });
        ...
        it('should handle invalid coin data', async () => {
            ...
            expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('Warning: Invalid coin data found'));
        });
        ...
        it('should handle errors when listing coins', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Error fetching coin list:'));
    ...
    describe('getTopCoins', () => {
        it('should get top coins successfully', async () => {
            ...
            expect(console.log).toHaveBeenCalledWith(expect.stringContaining('Fetching top coins...'));
        });
        ...
        it('should handle errors when getting top coins', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Error fetching top coins:'));
            expect(process.exit).toHaveBeenCalledWith(1);
        });
